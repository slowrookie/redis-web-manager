...
registerIcons({
  icons: {
    ...
    // extension
    Lua: (
      <svg version="1.0" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25px" height="25px" viewBox="0 0 947 947" enableBackground="new 0 0 947 947" >
        <g>
		...
		S835.5,673.4,835.5,473.6" />
          ...
          <path fill="none" stroke="#808080" strokeWidth="10.8612" strokeMiterlimit="10" strokeDasharray="40.8475" d="M890.6,261
